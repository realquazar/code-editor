    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#6f3fe9] flex items-center gap-2">
                <Plus size={24} className="text-[#4a1be2]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                            ${
                              ...
                              ? "border-[#7d3fe9]  shadow-[0_0_0_1px_#5D3FD3,0_8px_20px_rgba(0,0,263,0.15)]"
                              : "hover:border-[#913fe9] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                            }
                          `}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#541af5] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#6c3fe9] hover:bg-[#471eb9]"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#5e3fe9]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#5D3FD3,0_8px_20px_rgba(0,63,163,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#503fe9]" />
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <Button
                className="bg-[#673fe9] hover:bg-[#5736d0]"
